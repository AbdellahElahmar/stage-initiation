...
{
    public partial class FRM_Details_Bon_Retour : Form
    {
        private UserControl UserCommand;
        private dbstockContext db;
        public FRM_Details_Bon_Retour(UserControl user)
        {
            InitializeComponent();
        ...
        public void ActualiserDetailBon()
        {
            ...
            {
                dvgDetailBon.Rows.Add(L.ID, L.Reference, L.Quantite, L.Prix, L.Total);
            }
        }
        ...
        private void FRM_Details_Bon_Retour_Load(object sender, EventArgs e)
        {
            rempliredvgroduit();
        }
        ...
        {
            FRM_Produit_Retour FrmPR = new FRM_Produit_Retour(this);
            FrmPR.lblId.Text = dvgProduit.CurrentRow.Cells[0].Value.ToString();
            FrmPR.labelDesignation.Text = dvgProduit.CurrentRow.Cells[1].Value.ToString();
            FrmPR.lblRef.Text = dvgProduit.CurrentRow.Cells[2].Value.ToString();
            FrmPR.lblQtt.Text = dvgProduit.CurrentRow.Cells[3].Value.ToString();
            FrmPR.labelPrixU.Text = dvgProduit.CurrentRow.Cells[4].Value.ToString();
            FrmPR.ShowDialog();
        }
        ...
        private void btnEnregistrer_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    clsBon.Ajouter_Bon(Bondate.Value, IDAFFAIRE, Convert.ToInt32(ComboBoxLivreur.SelectedValue), Convert.ToInt32(ComboBoxDemandeur.SelectedValue),labelBR.Text);
                    foreach (var l in BL.D_Bon.DetailsBon)
                    {

                        clsBon.AjouterDetailBon(l.ID, l.Designation, l.Reference, l.Quantite, l.Prix);
                        clsProduit.RajouterQuantite(l.ID, l.Quantite);
                        ...
                        {
                            clsBL.diminuerQuantiteBL(IDAFFAIRE, l.Reference, l.Designation, l.Quantite);
                        }
